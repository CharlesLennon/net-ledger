  ...
  function createWireConfigPanel() {
    ...
    panel.innerHTML = `
            ...
            <div style="display: grid; grid-template-columns: 1fr 80px; gap: 8px; align-items: center;">
                ...
                <div id="group-section" style="grid-column: 1 / -1; margin: 12px 0 8px 0; padding: 8px 12px; background: rgba(139, 92, 246, 0.1); border-radius: 6px; border-left: 3px solid #8b5cf6;">
